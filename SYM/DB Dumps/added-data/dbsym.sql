...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 12, 2016 at 11:59 AM
...
(12, '-oHdio9dI7bYDQwQXAxVgUgvD-LWca52', 'WR', 'FES', '4322', 'Mr', 'Tharinda', 'Rodrigo', 'tharindarodrigo@gmail.com', '774479260', '910930109V', '3', '1590', '1923', 200000, 1, '15', 2, '2016-08-16', 2, 2, NULL, NULL, NULL),
(3, '09bS6o9IXlSAk072FpOXNLkQtMjOmVw2', 'PO', 'VSA', '4568', 'Mr', 'sachith', 'rodrigo', 'sachith5593@live.com', '778118805', '910930109V', '2', '16', '1927', 12112, 1, '15', 2, '2016-08-16', 2, 2, NULL, NULL, NULL),
(2, '5229BKvJN09sOewsT7fHV5wEUWywyzcZ', 'MN', 'CAS', '9875', 'Mr', 'Tharinda', 'Rodrigo', 'tharindarodrigo@gmail.com', '774479260', '910930109V', '3', '1590', '2015', 100000, 1, '15', 2, '2016-08-16', 2, 2, NULL, NULL, NULL),
(7, 'B-ABjqqgs6NbyVQPZegXNokLtNiRGh3m', 'WE', 'CAR', '1202', 'Mr', 'Tharinda', 'Rodrigo', 'tharindarodrigo@gmail.com', '774479260', '910930109V', '3', '1590', '1924', 200000, 1, '15', 2, '2016-08-16', 2, 2, NULL, NULL, NULL),
(8, 'b8zNWgOIdEYIlVu7JijkAD3VXeDGwEs8', 'WE', 'CAR', '1202', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '15', 2, '2016-08-16', 2, 2, NULL, NULL, NULL),
(1, 'BY3xHZG-ti_0tmdkOF6n0tiYuH-dMw0K', 'ER', 'VSA', '4568', 'Mr', 'sachith', 'rodrigo', 'sachith5593@live.com', '778118805', '910930109V', '2', '16', '1926', 1000000, 1, '15', 2, '2016-08-16', 2, 2, NULL, NULL, NULL),
(11, 'h5xS8v_HsdpoQM_12V3e7_1zqCzHUieA', 'WP', 'EER', '1258', 'Mr', 'Tharinda', 'Rodrigo', 'tharindarodrigo@gmail.com', '774479260', '910930109V', '3', '1590', '1927', 10000, 1, '15', 2, '2016-08-16', 2, 2, NULL, NULL, NULL),
(4, 'orlSr86796jceV-u3eJnAbNKivWE5jFE', 'BF', 'CAR', '3487', 'Mr', 'Tharinda', 'Rodrigo', 'tharindarodrigo@gmail.com', '774479260', '910930109V', '3', '1590', '1927', 200000, 1, '15', 2, '2016-08-16', 2, 2, NULL, NULL, NULL),
(9, 'ox_XAMJHqUm5ofguZuyfxOg6t_pbi3kz', 'WP', 'DAS', '1452', 'Mr', 'Tharinda', 'Rodrigo', 'tharindarodrigo@gmail.com', '774479260', '910930109V', '3', '1590', '1926', 10000000, 1, '15', 2, '2016-08-16', 2, 2, NULL, NULL, NULL),
(10, 'SZbTJriqz6QQzRB-8mB5emZ24tmbcSmV', 'W)', 'GS', '5869', 'Mr', 'sachith', 'rodrigo', 'sachith5593@live.com', '69856998', '910930109V', '2', '18', '1925', 5000000, 1, '15', 2, '2016-08-16', 2, 2, NULL, NULL, NULL),
(5, 'VVFYVqiV9UwAfLhnULTooNTQ_J_WceYJ', 'VB', 'VSA', '3487', 'Mr', 'Tharinda', 'Rodrigo', 'tharindarodrigo@gmail.com', '774479260', '910930109V', '2', '16', '1926', 12112, 1, '15', 2, '2016-08-16', 2, 2, NULL, NULL, NULL),
(6, 'w2xjZhe8f90U_oqCZesm35FgF9TXALvt', 'MO', 'CAS', '1202', 'Mr', 'Tharinda', 'Rodrigo', 'tharindarodrigo@gmail.com', '774479260', '910930109V', '3', '1590', '1927', 12000, 1, '15', 2, '2016-08-16', 2, 2, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `persona_info_single` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `single_basic_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `single_travel_basic_info`
--

DROP TABLE IF EXISTS `single_travel_basic_info`;
CREATE TABLE IF NOT EXISTS `single_travel_basic_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `dob` date NOT NULL,
  `email` varchar(45) NOT NULL,
  `cover_type` tinyint(4) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `single_travel_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `single_travel_personal_info`
--

DROP TABLE IF EXISTS `single_travel_personal_info`;
CREATE TABLE IF NOT EXISTS `single_travel_personal_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `travel_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `travel_medical` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `travel_values` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
